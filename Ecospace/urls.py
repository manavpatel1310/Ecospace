"""
URL configuration for Ecospace project.
...
from django.conf import settings
from django.conf.urls.static import static
admin.site.site_header="Ecospace Admin"
admin.site.site_title ="Ecospace Admin Portal"
from payments.views import payment_view, payment_success

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', include('EcospaceEcom.urls','EcospaceEcom'), name='EcospaceEcom'),
