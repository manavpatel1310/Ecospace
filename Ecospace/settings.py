"""
Django settings for Ecospace project.
...
WSGI_APPLICATION = 'Ecospace.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'support@Ecospace.com'
EMAIL_HOST_PASSWORD = 'admin'
DEFAULT_FROM_EMAIL = 'support@Ecospace.com'
